...
URL_INTRADAY = "https://api.upstox.com/v3/historical-candle/NSE_EQ|{isin}/minutes/5/{to_date}/{from_date}"
...
async def process_company(app_pool, client, isin, symbol, fetch_swing=True, fetch_intraday=False, current_idx=1, total_stocks=1):
    ...
    intraday_candles = []
    if fetch_intraday:
        intraday_url = URL_INTRADAY.format(isin=isin, to_date=to_date, from_date=from_date_intraday)
